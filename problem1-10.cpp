...
int main() {
      ...
      */
      /* int a;
       ...
       else if ( a>= 0 && a%2 == 1 ) cout << "The number is positive and odd " << endl;
      ...
      if ( c > b && c > a ) { cout << c << " is the largest " << endl; }
  */
      /*int a, b;
      cin >> a >> b;
      ...
      /*int a;
      cin >> a;
      if ( (a%100 == 0  && a%400 != 0) || a % 4 != 0 ) { cout << a << " is not a leap year " << endl; }
      ...
      cin >> a;
      int a_char= a;
      if ( a_char >=65 && a_char<=90 ) { cout << "Uppercase alphabet " << endl;}
      if ( a_char >= 97 && a_char <= 122 ) { cout << "Lowercase alphabet " << endl;}
      else {cout << "It is not an alphabet " << endl;}*/
      /*int a, b;
      cin >> a >> b;
      if ( pow((pow(a,2)+pow(b,2)) , 0.5) <= 10) cout << " Point ( " << a << ", " << b << " ) is in circle" << endl;
      else cout << " Point ( " << a << ", " << b << " ) is not in circle" << endl;*/
      ...
      cin >> weight2 >> price2;
      if ( price1/weight1 > price2/weight2 ) cout << " Package 2 has a better price" << endl;
      else if ( price1/weight1 == price2/weight2 ) cout << " Two packages have the same price " << endl;
      else cout << " Package 1 has a better price" << endl;*/
